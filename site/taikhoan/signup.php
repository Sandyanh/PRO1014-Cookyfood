...
<!-- Mirrored from maraviyainfotech.com/projects/erratum/main/waves/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2024 13:33:03 GMT -->
<head>
                ...
                <div class="content-detail">
                    ...
                    <form class="signup-form" method="post">
                        <div class="imgcontainer">
                            <img src="assets/images/cooky.png" alt="logo" class="avatar" style="width:200px">
                        </div>
                        <div class="input-control">
                            <div class="row p-l-5 p-r-5">
                                ...
                                <div class="col-md-6 p-l-10 p-r-10">
                                    <input type="password" placeholder="Mật khẩu.." name="psw"
                                ...
                                <div class="col-md-6 p-l-10 p-r-10">
                                    <span class="password-field-show">
                                        <input class="password-field input-checkmark" type="password"
                                            placeholder="Nhập lại mật khẩu" name="psw" required>
                            ...
                            <div class="login-with-btns">
                                ...
                                <span class="already-acc">Bạn đã có tài khoản rồi? <a href="login.php"
