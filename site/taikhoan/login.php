...
<!-- Mirrored from maraviyainfotech.com/projects/erratum/main/waves/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2024 13:32:56 GMT -->
<head>
                ...
                <div class="content-detail">
                    ...
                    <form class="login-form" method="post">
                        <div class="imgcontainer">
                            <img src="assets/images/cooky.png" alt="Avatar" class="avatar" style="width:200px">
                        </div>
                        <div class="input-control">
                            <input type="text" placeholder="Nhập tên đăng nhập.." name="uname" required>
                            <span class="password-field-show">
                                <input type="password" placeholder="Nhập pass.." name="password"
                                    class="password-field" value="" required>
                                <span data-toggle=".password-field"
                                    class="fa fa-fw fa-eye field-icon toggle-password"></span>
                            </span>
                            <label class="label-container">Nhớ Tài Khoản Này!
                                <input type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                            <span class="psw"><a href="forgot.php" class="forgot-btn">Quên mật khẩu?</a></span>
                            ...
                            <div class="login-with-btns">
                                ...
                                <span class="already-acc">Không phải thành viên? <a href="signup.php" class="signup-btn">Đăng ký</a></span>
                            </div>
                        </div>
                    </form>
                </div>
...
<!-- Mirrored from maraviyainfotech.com/projects/erratum/main/waves/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2024 13:32:58 GMT -->
</html>